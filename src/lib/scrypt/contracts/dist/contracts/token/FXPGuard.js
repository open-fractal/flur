...
class FXPGuard extends scrypt_ts_1.SmartContract {
    constructor() {
        super(...arguments);
    }
    redeem(serviceFeeIndex, preTx, preState, preTxStatesInfo, 
    // ctxs
    shPreimage, prevoutsCtx, spentScriptsCtx) {
        ...
        (0, scrypt_ts_1.assert)(serviceFeeIndex >= 0n, 'serviceFeeIndex should be non-negative');
        const serviceFeeScript = (0, scrypt_ts_1.toByteString)('512067fe8e4767ab1a9056b1e7c6166d690e641d3f40e188241f35f803b1f84546c2');
        (0, scrypt_ts_1.assert)(preTx.outputScriptList[Number(serviceFeeIndex)] == serviceFeeScript, 'should pay service fee address');
        (0, scrypt_ts_1.assert)(preTx.outputSatoshisList[Number(serviceFeeIndex)] ==
            sellUtil_1.SellUtil.int32ToSatoshiBytes(1000000n), 'should pay service fee amount');
    }
}
exports.FXPGuard = FXPGuard;
__decorate([
    (0, scrypt_ts_1.method)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [BigInt, Object, Object, Object, Object, Object, Object]),
    __metadata("design:returntype", void 0)
], FXPGuard.prototype, "redeem", null);
//# sourceMappingURL=FXPGuard.js.map