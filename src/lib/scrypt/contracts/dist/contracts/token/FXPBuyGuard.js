...
class FXPBuyGuard extends scrypt_ts_1.SmartContract {
    constructor() {
        super(...arguments);
    }
    ...
    shPreimage, prevoutsCtx, spentScriptsCtx) {
        ...
        (0, scrypt_ts_1.assert)(preTx.outputScriptList[Number(2)] == serviceFeeScript ||
            preTx.outputScriptList[Number(3)] == serviceFeeScript, 'should pay service fee address');
        (0, scrypt_ts_1.assert)(preTx.outputSatoshisList[Number(2)] == serviceFeeSats ||
            preTx.outputSatoshisList[Number(3)] == serviceFeeSats, 'should pay service fee amount');
    }
}
exports.FXPBuyGuard = FXPBuyGuard;
__decorate([
    (0, scrypt_ts_1.method)(),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Object, Object, Object, Object, Object, Object]),
    __metadata("design:returntype", void 0)
], FXPBuyGuard.prototype, "redeem", null);
//# sourceMappingURL=FXPBuyGuard.js.map